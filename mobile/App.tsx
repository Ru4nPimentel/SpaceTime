...
export default function App() {
  ...
  return (
    <ImageBackground source={blurBg} className="flex-1 px-8 py-10 relative bg-gray-900 " imageStyle={{ position: 'absolute', left: '-100%' }}>
      ...
      <Text className='text-center font-body text-sm leading-relaxed text-gray-200'> Feito com amor no </Text>
